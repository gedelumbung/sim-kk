...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'username',array('size'=>60,'maxlength'=>128, 'class'=>'input-block-level')); ?>
	...
	<div class="row">
		...
		<?php $model->password = ""; ?>
		<?php echo $form->passwordField($model,'password',array('size'=>60,'maxlength'=>128, 'class'=>'input-block-level')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'email',array('size'=>60,'maxlength'=>128, 'class'=>'input-block-level')); ?>
