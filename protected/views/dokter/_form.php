...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'tempat_tanggal_lahir',array('size'=>60,'maxlength'=>150, 'class'=>'input-block-level')); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'no_telepon',array('size'=>60,'maxlength'=>150, 'class'=>'input-block-level')); ?>
		<?php echo $form->error($model,'no_telepon'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'spesialis'); ?>
		<?php echo $form->textField($model,'spesialis',array('size'=>60,'maxlength'=>150, 'class'=>'input-block-level')); ?>
